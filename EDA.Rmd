...
png("images/qqplot.png", width = 1400, height = 800)
...
```{r}
jerseys$log_price = log(jerseys$price.value)
jerseys_clean = na.omit(jerseys)
...
png("images/qqplot_log_price.png", width = 1400, height = 800)
resids = resid(lm_log)
